...
- `wireframes/`: archivos SVG de wireframes y prototipos de alta fidelidad.
- `ReporteDefectos.md`: reporte de 5 defectos detectados y resueltos durante el desarrollo.
