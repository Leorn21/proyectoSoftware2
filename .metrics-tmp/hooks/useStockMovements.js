 ...
 */
export var useStockMovements = function () {
    var _a = useState([]), movements = _a[0], setMovements = _a[1];
    var _b = useState(true), loading = _b[0], setLoading = _b[1];
    var _c = useBatches(), getBatch = _c.getBatch, updateAvailableQuantity = _c.updateAvailableQuantity;
    ...
    var calculateAvailableQuantity = useCallback(function (batchId) {
