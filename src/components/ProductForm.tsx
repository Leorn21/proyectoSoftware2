    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-400">
          Completá la información base para identificarlo y clasificarlo en
          inventario.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div>
          ...
          {errors.category && (
            <p className="mt-2 text-sm text-rose-400">{errors.category}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.unit && (
            <p className="mt-2 text-sm text-rose-400">{errors.unit}</p>
          )}
        </div>
      </div>
